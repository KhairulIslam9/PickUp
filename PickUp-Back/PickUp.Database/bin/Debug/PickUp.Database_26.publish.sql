...
CREATE VIEW [dbo].[V_User]
	...
	FROM [User] U
GO
PRINT N'Création de [dbo].[ConvertDate]...';
...
END
GO
PRINT N'Création de [dbo].[ConvertTime]...';
...
END
GO
PRINT N'Création de [dbo].[DeletePickReservation]...';
...
BEGIN
	...
	C.[Email],C.DeviceToken, C.[Url], C.[ThumbnailUrl]
	FROM [Customer] C
	WHERE [Email] = @Email 
