...
BEGIN
	...
	SELECT @ResDate = ResDate
	FROM Reservation
	WHERE ReservationId = @ReservationId

	IF (GETDATE() < DATEDIFF(day, -1, @ResDate))
	BEGIN
		DELETE
...
BEGIN
	...
	AND R.ResDate BETWEEN GETDATE()-1 AND DATEADD(wk, DATEDIFF(wk, 2, GETDATE()))
...
BEGIN
	...
	BEGIN
		...
		VALUES(@ReservationId,@CustomerId,@NumPerson,Now())
	END
END
GO
